...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.setStyleSheet("background-color: rgb(111, 161, 123)")
        ...
        self.in_Name.setStyleSheet("background-color: rgb(197, 232, 206)")
        ...
        self.b_Start.setStyleSheet("background-color: rgb(87, 181, 111)")
        self.b_Start.setFont(font_b)
        self.lcdNumber = QLCDNumber(self.centralWidget)
        self.lcdNumber.setGeometry(110, 210, 70, 30)
        self.lcdNumber.setStyleSheet("background-color: rgb(197, 232, 206))")
        ...
        self.ls_Players.setStyleSheet("background-color: rgb(197, 232, 206)")
        ...
        self.b_Exit.setStyleSheet("background-color: rgb(87, 181, 111)")
