...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.setStyleSheet("background-color: rgb(0, 205, 105)")
        ...
        font_name.setFamily("Times New Roman")
        font_name.setPixelSize(20)
        font_data = QtGui.QFont()
        font_data.setFamily("Times New Roman")
        font_data.setPixelSize(16)
        font_b = QtGui.QFont()
        font_b.setFamily("Times New Roman")
        font_b.setPixelSize(18)
        self.label = QLabel(self.centralWidget)
        self.label.setText("Add meg a neved!")
        self.label.setGeometry(50, 40, 200, 50)
        self.label.setFont(font)
        self.label.setAlignment(Qt.AlignCenter)
        self.in_Name = QTextEdit(self.centralWidget)
        self.in_Name.setGeometry(50, 80, 200, 35)
        self.in_Name.setStyleSheet("background-color: rgb(205, 222, 255)")
        ...
        self.b_Start.setGeometry(50, 120, 200, 40)
        self.b_Start.clicked.connect(self.clickStart)
        self.b_Start.setStyleSheet("background-color: rgb(205, 222, 255)")
        self.b_Start.setFont(font_b)
        self.lcdNumber = QLCDNumber(self.centralWidget)
        self.lcdNumber.setGeometry(110, 210, 70, 30)
        self.lcdNumber.setStyleSheet("background-color: rgb(205, 222, 255)")
        self.timer0 = QtCore.QTimer()
        self.timer0 = QtCore.QTimer()
        self.time = QtCore.QTime(00, 00, 00)
        self.label2 = QLabel(self.centralWidget)
        self.label2.setText('Eddigi eredmények')
        self.label2.setGeometry(50, 290, 200, 30)
        self.label2.setFont(font)
        self.label2.setAlignment(Qt.AlignCenter)
        self.ls_Players = QTextBrowser(self.centralWidget)
        self.ls_Players.setGeometry(50, 320, 200, 300)
        self.ls_Players.setStyleSheet("background-color: rgb(205, 222, 255)")
        ...
        self.b_Exit.setStyleSheet("background-color: rgb(205, 222, 255)")
